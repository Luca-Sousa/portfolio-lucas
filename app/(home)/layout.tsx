  ...
  return (
    <html lang="ptBr">
      <body className={`${inter.className} antialiased`}>
        <div className="flex flex-col gap-4 overflow-hidden p-4 pb-[86px] sm:mx-auto sm:max-w-xl sm:gap-8 sm:py-8 md:max-w-2xl lg:h-full lg:max-w-4xl xl:max-w-[1536px] xl:flex-row xl:gap-10 xl:px-8 2xl:px-0">
