            ...
            <Card className="basis-1/2">
                ...
                <div className="text-center">
                  ...
                  <p className="text-xs text-muted-foreground">
                    ...
                    <Link
                      ...
                      href={"https://www.linkedin.com/showcase/saper-dot-edu/"}
                    >
                      Saper.edu
                    </Link>{" "}
                    |{" "}
              ...
              <CardContent className="space-y-2 text-sm">
                ...
                <ul className="ml-6 space-y-2">
                  ...
                  <li className="flex items-center gap-1">
                    <span className="inline-flex items-center gap-2 fill-primary">
                      <FaDatabase className="fill-primary" size={16} /> Banco de
                      Dados
                    </span>
                    ( Oracle )
                  </li>
                  ...
                  <li className="flex items-center gap-1">
                    <span className="inline-flex items-center gap-2 fill-primary">
                      <CodeSquare className="text-primary" size={16} /> Backend
                    </span>
                    (Spring Boot)
                  </li>
                  ...
                  <li className="flex items-center gap-1">
                    <span className="inline-flex items-center gap-2 fill-primary">
                      <MdWebhook className="fill-primary" size={16} /> Frontend
                    </span>
